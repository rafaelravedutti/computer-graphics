...
void CG::update(float dt)
{
    ...
    float moon_tx = moonOrbitRadius * cos(time * glm::radians(360.0 / moonRevolutionTime));
    float moon_ty = moonOrbitRadius * sin(time * glm::radians(360.0 / moonRevolutionTime));
